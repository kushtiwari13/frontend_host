                    ...
                    <div className="collapse navbar-collapse" id="navbarNavDropdown">
                        <ul className="navbar-nav ml-auto">
                            <li className="dropdown nav-item active">
                                <a href="#" className="" data-toggle="dropdown">WHY KSA <i className="fa fa-angle-down"></i></a>
                            ...
                            <li className="dropdown nav-item">
                                <a href="#" className="" data-toggle="dropdown">PARTNERS<i className="fa fa-angle-down"></i></a>
                                {/* <ul className="dropdown-menu" role="menu">
                            ...
                            <li className="nav-item dropdown">
                                <a href="#" className="" data-toggle="dropdown">AGENDA <i className="fa fa-angle-down"></i></a>
                                <ul className="dropdown-menu" role="menu">
                                    <li><a href="schedule-list.html">AGENDA 1</a></li>
                                    <li><a href="schedule-tab-1.html">AGENDA 2</a></li>
                                    <li><a href="schedule-tab-2.html">AGENDA 3</a></li>
                                </ul>
                            </li>
                            {/* <li className="nav-item dropdown">
                            ...
                            <li className="header-ticket nav-item">
                                <a className="ticket-btn btn" href="pricing.html"> 
                                Register
                                </a>
                            </li>
                        </ul>
